...
.DEFINE C_MS01_Timer_Setting_X1	C_Timer_Setting_16K
.DEFINE C_MS01_Timer_Setting_X2	C_Timer_Setting_32K

//=========================================================================
//	全局函数声明
//=========================================================================
.PUBLIC F_SACM_MS01_Init
...
.PUBLIC F_SACM_MS01_RampUpDAC1
.PUBLIC F_SACM_MS01_RampUpDAC2
.PUBLIC F_SACM_MS01_RampDnDAC1
.PUBLIC F_SACM_MS01_RampDnDAC2
...
// 函数名称：	SACM_MS01_Init
// C调用：		无
// 汇编调用：	F_SACM_MS01_Init
// 实现功能：   (仅被库函数调用)MS01初始化过程
// 入口参数：	无
// 出口参数：	无
// 破坏寄存器：	r1
//======================================================
...
//======================================================
// 函数名称：	SACM_MS01_DAC_Timer_X1
// C调用：		无
// 汇编调用：	F_SACM_MS01_DAC_Timer_X1
...
F_SACM_MS01_DAC_Timer_X1:
	...
	[P_TimerA_Ctrl] = r1
	r1= C_MS01_Timer_Setting_X1		// TimerA setting
	[P_TimerA_Data] = r1
	pop r1 from [sp]
	retf

//======================================================
// 函数名称：	SACM_MS01_DAC_Timer_X2
// C调用：		无
// 汇编调用：	F_SACM_MS01_DAC_Timer_X2
...
//======================================================
// 函数名称：	SACM_MS01_SendDAC1
// C调用：		无
// 汇编调用：	F_SACM_MS01_SendDAC1
...
//======================================================
// 函数名称：	SACM_MS01_SendDAC2
// C调用：		无
// 汇编调用：	F_SACM_MS01_SendDAC2
...
//======================================================
// 函数名称：	SACM_MS01_EndPlay
// C调用：		无
// 汇编调用：	SACM_MS01_EndPlay
...
//======================================================
// 函数名称：	SACM_MS01_RampUpDAC1
// C调用：		无
// 汇编调用：	F_SACM_MS01_RampUpDAC1
// 实现功能：   (仅被库函数调用)在一段语音播放开始前执行的渐入过程(DAC1)
// 入口参数：	无
// 出口参数：	无
// 破坏寄存器：	无
//======================================================
F_SACM_MS01_RampUpDAC1:
	push r1 to [sp]
	r1 = [P_DAC1]
	r1 &= 0xffc0
	cmp r1, 0x8000
...
//======================================================
// 函数名称：	SACM_MS01_RampUpDAC2
// C调用：		无
// 汇编调用：	F_SACM_MS01_RampUpDAC2
// 实现功能：   (仅被库函数调用)在一段语音播放开始前执行的渐入过程(DAC2)
// 入口参数：	无
// 出口参数：	无
// 破坏寄存器：	无
//======================================================
F_SACM_MS01_RampUpDAC2:
	push r1 to [sp]
	r1 = [P_DAC2]
	r1 &= 0xffc0
	cmp r1, 0x8000
...
//======================================================
// 函数名称：	SACM_MS01_RampDnDAC1
// C调用：		无
// 汇编调用：	F_SACM_MS01_RampDnDAC1
// 实现功能：   (仅被库函数调用)在一段语音播放结束后执行的渐出过程(DAC1)
// 入口参数：	无
// 出口参数：	无
// 破坏寄存器：	无
//======================================================
F_SACM_MS01_RampDnDAC1:
	push r1 to [sp]
	r1 = [P_DAC1]
	r1 &= 0xffc0
	jz ?L_Exit
...
//======================================================
// 函数名称：	SACM_MS01_RampDnDAC2
// C调用：		无
// 汇编调用：	F_SACM_MS01_RampDnDAC2
// 实现功能：   (仅被库函数调用)在一段语音播放结束后执行的渐出过程(DAC2)
// 入口参数：	无
// 出口参数：	无
// 破坏寄存器：	无
//======================================================
F_SACM_MS01_RampDnDAC2:
	push r1 to [sp]
	r1 = [P_DAC2]
	r1 &= 0xffc0
	jz ?L_Exit
