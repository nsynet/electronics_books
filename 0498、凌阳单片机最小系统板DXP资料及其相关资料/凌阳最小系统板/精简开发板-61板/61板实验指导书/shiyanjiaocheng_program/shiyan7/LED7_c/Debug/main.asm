...
.stabs "D:\\program\\shiyanjiaocheng_program\\shiyan7\\LED7_c/", 0x64, 0, 3, Ltext0
.stabs "D:/program/shiyanjiaocheng_program/shiyan7/LED7_c/main.c", 0x64, 0, 3, Ltext0
.code
Ltext0:
.debug
...
.code
.debug
	.dw '.stabs "LedLights:F19",36,0,0,',0,0,offset _LedLights,seg _LedLights,0x0d,0x0a
.CODE
.public _LedLights
_LedLights:	.proc
.debug
...
L3:
	...
	pop bp from [sp]
	retf
	.endp	// end of LedLights

.debug
	.dw '.stabs "BitValue:p1",160,0,0,3',0x0d,0x0a
.CODE
.debug
	.dw '.stabf ',0,0
	.dd LME2-_LedLights
...
LM20:
	R1=255	// QImode move
	[SP--]=R1	// QImode move
	call _LedLights	// call without return value
	SP=SP+1
.debug
...
.code
.debug
	.dw '.stabs "Pos:4",128,0,0,0',0x0d,0x0a
.CODE
.debug
	.dw '.stabs "TimerCnt:4",128,0,0,1',0x0d,0x0a
.CODE
.debug
