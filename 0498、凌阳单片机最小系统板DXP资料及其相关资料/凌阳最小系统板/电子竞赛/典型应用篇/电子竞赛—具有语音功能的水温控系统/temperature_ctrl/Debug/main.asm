...
// Command: D:\PROGRA~1\Sunplus\UNSPID~1.0\cc1.exe C:\DOCUME~1\张向艳\LOCALS~1\Temp\ccasaaaa.i -fkeep-inline-functions -quiet -dumpbase main.c -gstabs -o .\Debug/main.asm
// gcc2_compiled.:

.stabs "F:\\刻录光盘\\电子竞赛\\典型应用篇\\电子竞赛—具有语音功能的水温控系统\\temperature_ctrl/", 0x64, 0, 3, Ltext0
.stabs "F:/刻录光盘/电子竞赛/典型应用篇/电子竞赛—具有语音功能的水温控系统/temperature_ctrl/main.c", 0x64, 0, 3, Ltext0
.code
Ltext0:
.debug
...
_guiLED_Value:
	...
	.dw 0
.debug
	.dw '.stabs "G_ADC_flag:G1",32,0,0,',0,0,offset _G_ADC_flag,seg _G_ADC_flag,0x0d,0x0a
.CODE
.public _G_ADC_flag
.iram
_G_ADC_flag:
...
.debug
	.dw '.stabn 0x44,0,182,',0,0
	.dd LM64-_display_speech_ADC_temperature
	.dw 0x0d,0x0a
.code
LM64:
L14:
...
.debug
	.dw '.stabn 0x44,0,308,',0,0
	.dd LM143-_temperature_speech_index
	.dw 0x0d,0x0a
.code
LM143:
L76:
...
.debug
	.dw '.stabn 0x44,0,335,',0,0
	.dd LM162-_speech_start_address
	.dw 0x0d,0x0a
.code
LM162:
L83:
...
.debug
	.dw '.stabn 0x44,0,402,',0,0
	.dd LM206-_temperature_speech_play
	.dw 0x0d,0x0a
.code
LM206:
L117:
...
_status:
	.dw 0
.debug
	.dw '.stabs "giADC_DataSave:G27=ar1;0;9;4",32,0,0,',0,0,offset _giADC_DataSave,seg _giADC_DataSave,0x0d,0x0a
.CODE
.ram
...
_giADC_DataSave:
	.dw 10 dup(0)
.debug
	.dw '.stabs "iAddrSpeech:G4",32,0,0,',0,0,offset _iAddrSpeech,seg _iAddrSpeech,0x0d,0x0a
.CODE
.ram
.public _iAddrSpeech
_iAddrSpeech:
