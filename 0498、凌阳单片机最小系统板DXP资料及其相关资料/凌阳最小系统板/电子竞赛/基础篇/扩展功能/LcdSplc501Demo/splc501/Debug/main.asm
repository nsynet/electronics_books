...
// Command: D:\PROGRA~1\Sunplus\UNSPID~1\IDE180\cc1.exe D:\DOCUME~1\刘新颜\LOCALS~1\Temp\ccGIaaaa.i -fkeep-inline-functions -quiet -dumpbase main.c -gstabs -o .\Debug/main.asm
// gcc2_compiled.:

.stabs "F:\\功能扩展\\LcdSplc501Demo\\splc501/", 0x64, 0, 3, Ltext0
.stabs "F:/功能扩展/LcdSplc501Demo/splc501/main.c", 0x64, 0, 3, Ltext0
.code
Ltext0:
.debug
...
LM2:
LBB2:
	call _Init_irq5	// call with return value
.debug
