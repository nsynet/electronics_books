...
.stabs "F:\\电子竞赛\\C语言应用篇\\Source Code\\chapter6 Interrupt\\Chapter6_6_IRQ2&IRQ4/", 0x64, 0, 3, Ltext0
.stabs "F:/电子竞赛/C语言应用篇/Source Code/chapter6 Interrupt/Chapter6_6_IRQ2&IRQ4/ISR.c", 0x64, 0, 3, Ltext0
.code
Ltext0:
.debug
...
.CODE
.debug
	.dw '.stabs "g_uiIOA_LED:G4",32,0,0,',0,0,offset _g_uiIOA_LED,seg _g_uiIOA_LED,0x0d,0x0a
.CODE
.public _g_uiIOA_LED
.iram
_g_uiIOA_LED:
	.dw 255
.debug
	.dw '.stabs "g_uiIOB_LED:G4",32,0,0,',0,0,offset _g_uiIOB_LED,seg _g_uiIOB_LED,0x0d,0x0a
.CODE
.public _g_uiIOB_LED
.iram
_g_uiIOB_LED:
	.dw 255
.debug
	.dw '.stabs "g_uiClockCnt:G4",32,0,0,',0,0,offset _g_uiClockCnt,seg _g_uiClockCnt,0x0d,0x0a
.CODE
.public _g_uiClockCnt
.iram
_g_uiClockCnt:
	.dw 0
...
.text
LM11:
	R2=[_g_uiIOB_LED]	// QImode move
	R3=R2^0xffff	// one_cmplqi2
	[_g_uiIOB_LED]=R3	// QImode move
.debug
...
.text
LM19:
	R2=[_g_uiClockCnt]	// QImode move
	CMP R2,1023	// QImode compare
	JNA L15	// QImode GTU
	PC=L10
L15:
.debug
...
.text
LM22:
	R2=[_g_uiIOA_LED]	// QImode move
	R3=R2^0xffff	// one_cmplqi2
	[_g_uiIOA_LED]=R3	// QImode move
.debug
