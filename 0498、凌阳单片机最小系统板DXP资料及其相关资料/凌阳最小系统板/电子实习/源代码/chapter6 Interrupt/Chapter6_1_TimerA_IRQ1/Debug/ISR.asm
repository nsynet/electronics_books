...
.stabs "F:/电子竞赛/C语言应用篇/Source Code/chapter6 Interrupt/Chapter6_1_TimerA_IRQ1/ISR.c", 0x64, 0, 3, Ltext0
.code
Ltext0:
.debug
...
.CODE
.debug
	.dw '.stabs "uiOutput:G4",32,0,0,',0,0,offset _uiOutput,seg _uiOutput,0x0d,0x0a
.CODE
.public _uiOutput
.iram
_uiOutput:
...
.text
LM8:
	R2=[_uiOutput]	// QImode move
	R3=R2^0xffff	// one_cmplqi2
	[_uiOutput]=R3	// QImode move
.debug
