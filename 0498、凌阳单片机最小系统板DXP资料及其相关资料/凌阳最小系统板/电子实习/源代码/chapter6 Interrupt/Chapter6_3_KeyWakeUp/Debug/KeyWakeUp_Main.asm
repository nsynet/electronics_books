...
// Command: E:\PROGRA~1\Sunplus\UNSPID~3\IDE180\cc1.exe C:\DOCUME~1\李华丽.DOMAIN\LOCALS~1\Temp\ccUvaaaa.i -fkeep-inline-functions -quiet -dumpbase KeyWakeUp_Main.c -gstabs -o .\Debug/KeyWakeUp_Main.asm
// gcc2_compiled.:

.stabs "F:\\电子竞赛\\C语言应用篇\\Source Code\\chapter6 Interrupt\\Chapter6_3_KeyWakeUp/", 0x64, 0, 3, Ltext0
.stabs "F:/电子竞赛/C语言应用篇/Source Code/chapter6 Interrupt/Chapter6_3_KeyWakeUp/KeyWakeUp_Main.c", 0x64, 0, 3, Ltext0
.code
Ltext0:
.debug
...
.code
.debug
	.dw '.stabs "uiTem:4",128,0,0,0',0x0d,0x0a
.CODE
.debug
